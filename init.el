...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (zenburn-theme xclip which-key web-mode use-package tao-theme string-inflection spaceline solarized-theme rebecca-theme realgud pip-requirements phpunit package-lint org-pomodoro org-download org-bullets org-brain material-theme live-py-mode js2-refactor jbeans-theme ivy-hydra inkpot-theme hy-mode helm-make helm helm-core gruvbox-theme grandshell-theme ggtags flatland-theme eyebrowse exotica-theme evil-surround evil-org evil-nerd-commenter evil-matchit editorconfig dumb-jump drupal-mode dockerfile-mode docker darktooth-theme csv-mode counsel-projectile counsel swiper company-web company-php ac-php-core company-lua column-enforce-mode color-theme-sanityinc-tomorrow cmake-ide browse-at-remote bind-key base16-theme ace-window ace-link auctex company smartparens evil flycheck flyspell-correct window-purpose imenu-list ivy avy markdown-mode ht alert projectile org-plus-contrib magit magit-popup git-commit with-editor hydra php-mode f js2-mode s zen-and-art-theme yapfify yaml-mode xterm-color xcscope ws-butler winum white-sand-theme wgrep web-completion-data web-beautify volatile-highlights vi-tilde-fringe uuidgen unfill undo-tree underwater-theme ujelly-theme twilight-theme twilight-bright-theme twilight-anti-bright-theme toxi-theme toc-org test-simple tangotango-theme tango-plus-theme tango-2-theme tagedit systemd symon sunny-day-theme sublime-themes subatomic256-theme subatomic-theme stickyfunc-enhance srefactor spacegray-theme soothe-theme soft-stone-theme soft-morning-theme soft-charcoal-theme smyx-theme smex smeargle slim-mode shell-pop seti-theme scss-mode sass-mode reverse-theme reveal-in-osx-finder restart-emacs request rebox2 ranger rainbow-delimiters railscasts-theme pyvenv pytest pyenv-mode py-isort purple-haze-theme pug-mode professional-theme powerline popwin planet-theme pkg-info phpcbf php-extras php-auto-yasnippets phoenix-dark-pink-theme phoenix-dark-mono-theme persp-mode persistent-scratch pdf-tools pcre2el pbcopy password-generator paradox osx-trash osx-dictionary orgit organic-green-theme org-projectile org-present org-caldav open-junk-file omtose-phellack-theme oldlace-theme occidental-theme obsidian-theme noctilux-theme nhexl-mode neotree naquadah-theme mwim mustang-theme multiple-cursors multi-term mu4e-alert move-text monokai-theme monochrome-theme monky molokai-theme moe-theme mmm-mode minimal-theme markdown-toc mandm-theme majapahit-theme magit-gitflow madhat2r-theme macrostep lush-theme lua-mode lorem-ipsum log4e loc-changes load-relative livid-mode linum-relative link-hint light-soap-theme levenshtein less-css-mode launchctl json-mode js-doc jazz-theme jabber ivy-purpose ir-black-theme insert-shebang info+ indent-guide impatient-mode ietf-docs hungry-delete hl-todo highlight-parentheses highlight-numbers highlight-indentation hide-comnt heroku-theme hemisu-theme help-fns+ hc-zenburn-theme gruber-darker-theme graphviz-dot-mode goto-chg gotham-theme google-translate golden-ratio godoctor go-rename go-guru go-eldoc gnuplot gntp gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe git-gutter-fringe+ gh-md gandalf-theme fuzzy flyspell-correct-ivy flycheck-pos-tip flycheck-bashate flx-ido flatui-theme fish-mode fill-column-indicator farmhouse-theme fancy-battery expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-search-highlight-persist evil-numbers evil-magit evil-lisp-state evil-lion evil-indent-plus evil-iedit-state evil-exchange evil-escape evil-ediff evil-args evil-anzu eval-sexp-fu espresso-theme eshell-z eshell-prompt-extras esh-help erc-social-graph erc-image erc-hl-nicks emmet-mode elisp-slime-nav dracula-theme docker-tramp django-theme disaster diminish diff-hl darkokai-theme darkmine-theme darkburn-theme dakrone-theme cython-mode cyberpunk-theme company-tern company-statistics company-shell company-go company-c-headers company-auctex company-anaconda color-theme-sanityinc-solarized coffee-mode cmake-mode clues-theme clean-aindent-mode clang-format cherry-blossom-theme busybee-theme bubbleberry-theme birds-of-paradise-plus-theme badwolf-theme autothemer auto-yasnippet auto-highlight-symbol auto-dictionary auto-compile async apropospriate-theme anti-zenburn-theme ample-zen-theme ample-theme alect-themes aggressive-indent afternoon-theme adaptive-wrap ac-ispell)))
